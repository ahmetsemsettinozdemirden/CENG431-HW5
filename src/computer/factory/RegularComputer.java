...
public class RegularComputer implements Computer {
    ...
    public RegularComputer(CPU cpu, RAM ram, Keyboard keyboard, Mouse mouse, Headphones headphones, Monitor monitor) {
        this.cpu = cpu;
        this.ram = ram;
